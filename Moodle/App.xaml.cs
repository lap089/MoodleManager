...
namespace MoodleManager
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs e)
        {
            ...
            // If activated from a toast
            if (e.Kind == ActivationKind.ToastNotification)
            {
                
                rootFrame.Navigate(typeof(SignInPage), e.ToString());
                // TODO - navigate to the correct page depending on toast args
            }
            ...
            // TODO - handle any other types of activation
